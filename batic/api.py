...
@frappe.whitelist()
def get_list(doctype, filters={}, fields=['*'], order_by='modified desc', limit=10):
    return frappe.db.get_list(doctype, filters=filters, fields=fields, order_by=order_by, limit=limit)
